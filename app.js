...
app.use(function(req, res, next) {
  res.header("Access-Control-Allow-Origin", ["http://localhost:5173","https://wereiswaldo-mubbe127.netlify.app"] ); // update to match the domain you will make the request from
